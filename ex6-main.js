...
// 使用する画像のパスを指定
var selectedImage = repo_site + 'img/06.JPG';
...
var welcome3 = {
    type: "html-keyboard-response",
    stimulus: `次の画面は、真っ白な画面になります。spaceキーを長押しすると灰色の四角形が表示されるので、 絵画を見ていたと思う時間と同じ時間、四角形を表示させてください。<br>spaceキーを離すと四角形が消えます。<br>enterキーで次の画面に進みます。`,
    choices: ["Enter"]
};
