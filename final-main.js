...
var condition_trial = {
    ...
    stimulus: `<p>以下の項目について絵画を5段階で評価してもらいます。</p><br><p><strong>${test_rand.adjective1}</strong></p><p><strong>${test_rand.adjective2}</strong></p><br>Enterキーで次に進みます。`,
...
var hello_trial = {
    type: 'html-keyboard-response',
    stimulus: '<img id="jspsych-image" src="' + test_rand.img + '" style="display: none;">',
...
var rating_trial = {
    ...
    data: {task: 'response'},
    questions: [
        {name: "Q0", prompt: `<p><strong>${test_rand.adjective1}</strong></p>`, labels: ["1", "2", "3", "4", "5"], required: true},
        {name: "Q1", prompt: `<p><strong>${test_rand.adjective2}</strong></p>`, labels: ["1", "2", "3", "4", "5"], required: true}
    ],
